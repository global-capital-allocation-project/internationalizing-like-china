...
save "${gcap_data}/output/holdings_similarity/holdings_LC_Govt_currency_`year'_alt_thr.dta", replace
...
* saving correlations 
save "${gcap_data}/output/holdings_similarity/correlations_LC_Govt_currency_`year'_alt_thr.dta", replace
