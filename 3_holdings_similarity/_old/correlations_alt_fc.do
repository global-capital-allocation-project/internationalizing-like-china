...
keep MasterPortfolioId DomicileCountryId FundName asset_class* currency cgs_dom country_bg domestic marketvalue_usd year iso_currency_code
...
* keep Foreign Currency (ALTERNATIVE DEFINITION) only: 
drop domestic
gen domestic = 0 
...
save "${gcap_data}/output/holdings_similarity/holdings_LC_Govt_currency_`year'_alt_fc.dta", replace
...
* saving correlations 
save "${gcap_data}/output/holdings_similarity/correlations_LC_Govt_currency_`year'_alt_fc.dta", replace
