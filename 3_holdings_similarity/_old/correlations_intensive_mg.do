...
save "${gcap_data}/output/holdings_similarity/holdings_LC_Govt_currency_`year'_intensive_mg.dta", replace
...
* saving correlations 
save "${gcap_data}/output/holdings_similarity/correlations_LC_Govt_currency_`year'_intensive_mg.dta", replace
