...
install.packages("readstata13", repos = "http://cran.us.r-project.org", lib = "~/R/x86_64-pc-linux-gnu-library/3.5.1")
install.packages("data.table", repos="http://cran.us.r-project.org", lib = "~/R/x86_64-pc-linux-gnu-library/3.5.1")


require(readstata13, lib.loc = "~/R/x86_64-pc-linux-gnu-library/3.5.1")
...
# '--args tempdir="'$gcap_data'/shared/morningstar/temp/externalid" rawdir="'$gcap_data'/raw/externalid/latest"' 
...
extid.sub.mode.final$maturitydate <- as.Date(extid.sub.mode.final$maturitydate, origin='1960-01-01')
